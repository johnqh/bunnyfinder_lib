...
import type { FirebaseIdToken } from '@sudobility/bunnyfinder_client';
import {
  useHistories,
  useHistoriesTotal,
} from '@sudobility/bunnyfinder_client';
 ...
 * It orchestrates:
 * - **Data fetching** via TanStack Query hooks from `@sudobility/bunnyfinder_client`
